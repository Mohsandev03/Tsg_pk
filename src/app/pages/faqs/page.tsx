    ...
    <>
      ...
      <div id="header" className="relative w-full">
        ...
        <Breadcrumb
          heading="FAQs"
          subHeading="FAQs"
          backgroundImage="/images/bg/faq-bg.jpg" // ✅ Update this path if your image is stored elsewhere
        />
      </div>
        ...
        <div className="container">
          <div className="flex justify-between">
            ...
            <div className="right w-2/3">
              ...
              <div
                className={`tab-question flex flex-col gap-5 ${
                  activeTab === "exchanges & returns" ? "active" : ""
                }`}
              >
                <div
                  className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-line cursor-pointer ${
              ...
              <div
                className={`tab-question flex flex-col gap-5 ${
                  activeTab === "look after your garments" ? "active" : ""
                }`}
              >
                <div
                  className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-line cursor-pointer ${
