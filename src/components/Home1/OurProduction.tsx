  ...
  return (
    <div className="community-story-block md:mt-20 mt-10">
      <div className="container">
        <div className="heading3 text-center leading-10">
          Unleashing Creativity at Our <br></br> Production House
        </div>
        ...
        <div className="list-product grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 md:gap-[30px] gap-[16px] md:mt-10 mt-6">
          ...
          >
            <div className="bg-img w-full h-full">
              <iframe
                ...
                src="https://www.youtube.com/embed/Ke2LanQ3fRA?autoplay=0"
          ...
          <div
            className="product-item block h-full aspect-[3/4] relative md:rounded-2xl rounded-xl overflow-hidden cursor-pointer"
